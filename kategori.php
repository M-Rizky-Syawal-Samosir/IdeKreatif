    ...
    <!-- tabel data kategori --> 
     <div class="card">
        ...
        <!-- Tombol untuk menambah kategori baru --> 
         <button type="button" class="btn-primary" data-bs-toggle="modal" data-bs-target="#addCategory">
            Tambah kategori
</button>
</div>
<div class="card-body">
...
<tbody class="table-border-bottom-0">
    ...
    <div class="dropdown-menu">
        <a href="#" class="dropdown-item" data-bs-toogle="modal"
        data-bs-target="#ediCategory_<?= $category['category_id']; ?>">
   ...
   <!-- Input tersembunyi untuk menyimpan ID kategori -->
    <input type="hidden" name="catID" values="<?=
    $category['category_id']; ?>">
    <div  class="form-group">
    <label>Nama kategori</label>
    <!-- Input untuk nama kategori --> 
     <input type="text" value=" value="<?= $category['category_name']; ?>" name="category_name" class="form-control">
      </div>
      <div class="modal-footer">
