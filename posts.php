...
?>
<div class="container-xxl filex-grow-1 container-p-y">
    <!-- Judul halaman -->
     <div class="row">
        <!-- Form untuk menambahkan postingan baru -->
         <div class="col-md-10">
            <div class="card-mb-4">
            <div class="card-body">
                <form method="POST" action="proses_post_php"
                enctype="multipart/form-data">
                <!-- Input untuk menggugah gambar -->
                 <div class="mb-3">
                    <label for="post_title" class="form-label">Judul Postingan</label>
                    <input type="text" class="form-control"name="post_title" require></div>
                    <!-- Input untuk menggugah gambar -->
                     <div class="mb-3">
                        ...
                        <1-- Textarea untuk konten postingan -->
                            <div class="mb-3">
                                <label for="content" class="form-label">Konten</label>
                                <textarea class="form-control" id="content" name="content" require></textarea></div>
                                <!-- Tombol submit -->
